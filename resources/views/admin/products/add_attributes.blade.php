                  ...
                  <div class="col-sm-12">
                     <div class="panel panel-bd lobidrag">
                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/add-attribute/'.$productdetails->id)}}" method="post">  {{ csrf_field() }}
                             ...
                             <div class="form-group">
                                <div class="field_wrapper">
                                    <div style="display:flex;">
                                        ...
                                        <input type="text" name="stock[]" id="stock" placeholder="stock" class="form-control" style="width:120px;margin-right:10px;"/>
