                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/edit-product/'.$productDetails->id )}}" method="post">  {{ csrf_field() }}
                              ...
                              <div class="form-group">
                                ...
                                <textarea name="product_description" id="product_description" value="{{$productDetails->description}}" class="form-control"></textarea>
                              </div>
                             
                              <div class="form-group">
                                 <label>Product Prize </label>
                                 <input type="text" class="form-control" value="{{$productDetails->price}}" name="product_price" required>
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <img src="{{asset('/uploads/products/'.$productDetails->image )}}" style="width: 100px; margin-top:15px;">
                                @endif
